...
void lightScene()
{
	...
	**********************************/
	...
	GLfloat position0[] = {-2.5, -0.7, -1.0, 1.0};
	...
	**********************************/
	...
	GLfloat position1[] = {0.5, 1.5, 2.0, 0.0};
	...
	**********************************/
	...
	glTranslatef(-0.01, -0.01, -2.257);
	sphere();
	glPopMatrix();
	
	glPushMatrix();
		GLfloat position2[] = {0, 0.4, -2.65, 1.0};
		...
		glLightf(GL_LIGHT2, GL_SPOT_CUTOFF, 170.0);
	...
	**********************************/
		...
		GLfloat position3[] = {0.5, -0.7, -4.0, 1.0};
