************************************************************ Mini Project (Web Scraper for TxState CS Faculty) Author: Ryan Askew (raa97) Date  : 10/17/2017 ************************************************************ Instructions for use ------------------------------------------------------------Download the desired CS faculty webpages as HTML files(available at http://www.cs.txstate.edu/Personnel/Faculty) and place them in the same directory as index.php. 
